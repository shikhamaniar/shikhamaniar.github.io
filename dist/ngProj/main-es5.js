...
var AuthServiceService = /** @class */ (function () {
    ...
    // }
    AuthServiceService.prototype.register = function (user) {
        return this.http.post(this.baseurl + "/users", JSON.stringify(user), this.httpOptions).pipe(
        // retry(2),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (userdetails) {
            return userdetails;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorHandl));
    };
    // Error handling
    AuthServiceService.prototype.errorHandl = function (error) {
        console.log(error);
        var errorMessage = '';
    ...
    AuthServiceService.prototype.createRole = function (data) {
        return this.http.post(this.baseurl + "/roles", JSON.stringify(data), this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])(2), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (user) {
            console.log(user);
            return user;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorHandl));
    };
    AuthServiceService.prototype.viewAllRoles = function () {
    ...
    AuthServiceService.prototype.viewAllUsers = function () {
...
var CreateRoleComponent = /** @class */ (function () {
    // permissionList;
    function CreateRoleComponent(formBuilder, router, authService) {
    ...
    Object.defineProperty(CreateRoleComponent.prototype, "f", {
    ...
    CreateRoleComponent.prototype.onSubmit = function () {
        ...
        this.submitted = true;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.permissionsChecked), _c = _b.next(); !_c.done; _c = _b.next()) {
                var item = _c.value;
                this.arr.push({
                    id: item
                });
    ...
    CreateRoleComponent.prototype.onChange = function (permissionId) {
        if (this.permissionsChecked.find(function (x) { return x === permissionId; })) {
    ...
    Object.defineProperty(CreateRoleComponent.prototype, "permissionIds", {
        get: function () {
...
var SignUpComponent = /** @class */ (function () {
    function SignUpComponent(formBuilder, router, authService) {
        ...
        this.rolesChecked = [];
        this.arr = [];
        authService.viewAllRoles().subscribe(function (roles) {
    ...
    Object.defineProperty(SignUpComponent.prototype, "roleIds", {
        get: function () {
    ...
    SignUpComponent.prototype.onSubmit = function () {
        ...
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.rolesChecked), _c = _b.next(); !_c.done; _c = _b.next()) {
                var item = _c.value;
                this.arr.push({
                    id: item
                });
    ...
    SignUpComponent.prototype.onChange = function (roleId) {
        if (this.rolesChecked.find(function (x) { return x === roleId; })) {
...
var ViewAllRolesComponent = /** @class */ (function () {
    function ViewAllRolesComponent(service) {
        var _this = this;
        this.service = service;
        this.displayedColumns = ['id', 'name', 'permissions'];
        service.viewAllRoles().subscribe(function (roles) {
            _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](roles);
            _this.dataSource.paginator = _this.paginator;
            _this.dataSource.sort = _this.sort;
        });
    }
    ViewAllRolesComponent.prototype.ngOnInit = function () {
    };
    ViewAllRolesComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
        if (this.dataSource.paginator) {
            this.dataSource.paginator.firstPage();
        }
    };
    ViewAllRolesComponent.ctorParameters = function () { return [
...
var ViewAllUsersComponent = /** @class */ (function () {
    function ViewAllUsersComponent(service) {
        var _this = this;
        this.service = service;
        this.displayedColumns = ['username', 'email', 'phone',
            ...
            'accountNonLocked'];
        service.viewAllUsers().subscribe(function (users) {
    ...
    ViewAllUsersComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
        if (this.dataSource.paginator) {
            this.dataSource.paginator.firstPage();
        }
    };
    ViewAllUsersComponent.ctorParameters = function () { return [
        { type: _authentication_auth_service_service__WEBPACK_IMPORTED_MODULE_3__["AuthServiceService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_2__["MatPaginator"], { static: true })
